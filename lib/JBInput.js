...
class JBInputWebComponent extends HTMLElement {
    ...
    initNumberField(){
        ...
        const increaseNumber = ()=>{
            ...
            const newNumber = addFloatNumber(currentNumber, this.numberValueStep);
            this.value = newNumber;
        };
        const decreaseNumber = ()=>{
            const currentNumber = parseFloat(this.value);
            if(isNaN(currentNumber)){return;}
            const newNumber = addFloatNumber(currentNumber, (-1*this.numberValueStep));
            this.value = newNumber;
        };
        ...
        buttonsElement.querySelector('.increase-number-button').addEventListener('click',increaseNumber);
        buttonsElement.querySelector('.decrease-number-button').addEventListener('click',decreaseNumber);
